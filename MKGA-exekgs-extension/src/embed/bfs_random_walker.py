"""
Altering the RandomWalker implementation within pyrdf2vec to apply  
Breath First Search as done in initial implementation.

This implementation is used over a depth first strategy to greatly improve runtime.
"""
...
@attr.s
class BFSRandomWalker(Walker):
    """Random walking strategy which extracts walks from a rood node using the
    Breath First Search (BFS) changing the random walker provided by the pyrdf library.
